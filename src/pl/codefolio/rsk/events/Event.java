 ...
 * --------------------------------------------------------------------
 * 
 * An archetype class for each possible event.
 * 
...
public class Event {
	...
	public Event copy() throws InvalidDatetimeFormatException {
		return new Event(datetime.copy());
	}
	...
	public String toString() {
		return "[type: Unknown; datetime: "+datetime.getDatetimeCorrected()+"]";
	}
}
