 ...
 * --------------------------------------------------------------------
 * 
 * This event is constructed out of the chat lines.
 * 
...
public class ChatEvent extends Event {
	...
	public ChatEvent(Datetime datetime, Player player, String text) {
		super(datetime);
		this.player = player;
		this.text = text;
	}
	
	public ChatEvent copy() throws InvalidDatetimeFormatException {
		return new ChatEvent(datetime.copy(), player.copy(), new String(text));
	}
	...
	public String toString() {
		return "[type: Chat; player: "+player+"; text: "+text+"]";
	}
}
